...
@click.option('--forward_opt_steps', type=int, default=3, help='Number of forward opt steps in alternate training scheme')
@click.option('--backward_opt_steps', type=int, default=497, help='Number of backward opt steps in alternate training scheme')
