...
python3 time_series/main.py --data $DATASET --sde linear-momentum-sb --damp_coef 1. --beta_max 6 --dir results/critical_$DATASET
python3 time_series/generate_plots.py --path results/critical_$DATASET

python3 time_series/main.py --data $DATASET --sde linear-momentum-sb --damp_coef .7 --beta_max 6 --dir results/under_$DATASET
